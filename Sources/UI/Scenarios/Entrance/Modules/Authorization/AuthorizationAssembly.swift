...
final class AuthorizationAssembly: ViewControllerAssembly<AuthorizationViewController, AuthorizationViewModel> {

    // MARK: - Public
    func viewController(router: AnyRouter<EntranceRoute>) -> AuthorizationViewController {
        return define(scope: .prototype, init: R.storyboard.authorization.initial()!) {
