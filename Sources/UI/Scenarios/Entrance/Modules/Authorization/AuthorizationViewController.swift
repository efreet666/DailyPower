...
final class AuthorizationViewController: UIViewController, ModuleView {
    ...
    // MARK: - ModuleView
    var output: AuthorizationViewModel.Input {
        return AuthorizationViewModel.Input(
    ...
    func setupBindings(to viewModel: AuthorizationViewModel) -> Disposable {
