...
final class VideoViewStyle2: UIView {
    ...
    private func initialize() {
        guard let view = R.nib.videoViewStyle2(owner: self) else {
            fatalError("Unable to instantiate view from nib \(R.nib.videoViewStyle2)")
        }
        embedSubview(view)
        containerView = view
    }
...
extension Reactive where Base: VideoViewStyle2 {
